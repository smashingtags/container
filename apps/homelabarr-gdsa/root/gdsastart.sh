...
##export alias gdsagen='docker run -it -v /opt/appdata/system/servicekeys/:/system/servicekeys/ ghcr.io/dockserver/homelabarr-gdsa:latest /bin/bash /gdsastart.sh'
##source ~/.bashrc
